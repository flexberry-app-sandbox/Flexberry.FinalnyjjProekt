...
namespace IIS.FinalnyjjProekt
{
    ...
    public class ГрафикиОтпуска : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Номер.
        /// </summary>
        // *** Start programmer edit section *** (ГрафикиОтпуска.Номер CustomAttributes)

        // *** End programmer edit section *** (ГрафикиОтпуска.Номер CustomAttributes)
        public virtual int Номер
        {
            get
            {
                // *** Start programmer edit section *** (ГрафикиОтпуска.Номер Get start)

                // *** End programmer edit section *** (ГрафикиОтпуска.Номер Get start)
                int result = this.fНомер;
                // *** Start programmer edit section *** (ГрафикиОтпуска.Номер Get end)

                // *** End programmer edit section *** (ГрафикиОтпуска.Номер Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ГрафикиОтпуска.Номер Set start)

                // *** End programmer edit section *** (ГрафикиОтпуска.Номер Set start)
                this.fНомер = value;
                // *** Start programmer edit section *** (ГрафикиОтпуска.Номер Set end)

                // *** End programmer edit section *** (ГрафикиОтпуска.Номер Set end)
            }
        }
        ...
        // *** Start programmer edit section *** (ГрафикиОтпуска.Отправить CustomAttributes)

        // *** End programmer edit section *** (ГрафикиОтпуска.Отправить CustomAttributes)
        [ICSSoft.STORMNET.AccessType(ICSSoft.STORMNET.AccessType.none)]
        public virtual void Отправить()
        {
            // *** Start programmer edit section *** (ГрафикиОтпуска.Отправить method implementation)
            return;
            // *** End programmer edit section *** (ГрафикиОтпуска.Отправить method implementation)
        }
