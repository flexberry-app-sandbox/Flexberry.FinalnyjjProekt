...
(
	...
	"Наимнование" NVARCHAR2(255) NULL,
...
(
	...
	"СерияПас" NVARCHAR2(255) NULL,

	"НомерПас" NVARCHAR2(255) NULL,
...
ALTER TABLE "Отделы"
	ADD CONSTRAINT "Отделы_FОрган_9449" FOREIGN KEY ("Организации") REFERENCES "Организации" ("primaryKey");

CREATE INDEX "Отделы_IОргани_20" on "Отделы" ("Организации");
...
ALTER TABLE "Сотрудники"
	ADD CONSTRAINT "Сотрудники_FО_5381" FOREIGN KEY ("Организации") REFERENCES "Организации" ("primaryKey");

CREATE INDEX "Сотрудники_IО_6274" on "Сотрудники" ("Организации");
